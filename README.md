...
- `kubernetes/secrets/visibility/grafana-auth-credentials.unsealed.yaml`
  - Set: `username`, `password`
- `kubernetes/secrets/visibility/kubebox-kubeconfig.unsealed.yaml`
  - Auto-generated by `infra/deploy-local.sh` from your current Minikube kubeconfig
...
export ARGOCD_ADMIN_PASSWORD=egt307icantkube
